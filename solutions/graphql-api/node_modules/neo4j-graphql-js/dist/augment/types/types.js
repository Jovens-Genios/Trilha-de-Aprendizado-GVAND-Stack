...
var isSubscriptionTypeDefinition = function isSubscriptionTypeDefinition(_ref11) {
...
var augmentTypes = function augmentTypes(_ref17) {
  var typeDefinitionMap = _ref17.typeDefinitionMap,
      ...
      typeExtensionDefinitionMap = _ref17$typeExtensionD === void 0 ? {} : _ref17$typeExtensionD,
      generatedTypeMap = _ref17.generatedTypeMap,
      _ref17$operationTypeM = _ref17.operationTypeMap,
      operationTypeMap = _ref17$operationTypeM === void 0 ? {} : _ref17$operationTypeM,
      _ref17$config = _ref17.config,
      config = _ref17$config === void 0 ? {} : _ref17$config;
  var augmentationDefinitions = (0, _toConsumableArray2["default"])((0, _entries["default"])(_objectSpread({}, typeDefinitionMap, {}, operationTypeMap)));
  ...
  (0, _entries["default"])(typeExtensionDefinitionMap).forEach(function (_ref20) {
...
var buildNeo4jTypeFields = function buildNeo4jTypeFields(_ref26) {
  ...
  if (typeName === _temporal.TemporalType.DATE) {
    ...
    fields = (0, _entries["default"])(_objectSpread({}, _temporal.Neo4jTime)).filter(function (_ref27) {
    ...
    fields = (0, _entries["default"])(_objectSpread({}, _temporal.Neo4jDate, {}, _temporal.Neo4jTime)).filter(function (_ref29) {
...
var initializeOperationType = function initializeOperationType(_ref34) {
  var _ref34$typeName = _ref34.typeName,
      ...
      typeDefinitionMap = _ref34$typeDefinition === void 0 ? {} : _ref34$typeDefinition,
...
var buildAugmentationTypeMaps = function buildAugmentationTypeMaps(_ref35) {
  var queryTypeName = _ref35.queryTypeName,
      ...
      typeDefinitionMap = _ref35$typeDefinition === void 0 ? {} : _ref35$typeDefinition;
  return (0, _entries["default"])(typeDefinitionMap).reduce(function (_ref36, _ref37) {
...
var augmentSchemaType = function augmentSchemaType(_ref42) {
  ...
  operationTypeMap = (0, _entries["default"])(operationTypeMap).forEach(function (_ref43) {
