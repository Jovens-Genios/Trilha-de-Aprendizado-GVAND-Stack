...
<head>
    <title>Code coverage report for entities.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> entities.js</h1>
        <div class='clearfix'>
...
<a name='L145'></a><a href='#L145'>145</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">3x</span>
...
class Neo4jSchemaEntity {
  constructor(id, type, properties = <span class="branch-1 cbranch-no" title="branch not covered" >{}) {</span>
    this.id = id;
    this.type = type;
    this.properties = properties;
  }
&nbsp;
  asJSON() <span class="fstat-no" title="function not covered" >{</span>
...
&nbsp;
  getGraphQLTypeName() <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >    throw n</span>ew Error('Override me in subclass');
  }
&nbsp;
  getPropertyNames() {
...
&nbsp;
  addProperty(name, details) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (_.isNil(name) || _.isNil(details)) {
<span class="cstat-no" title="statement not covered" >      throw n</span>ew Error('Property must have both name and details');
    }
&nbsp;
