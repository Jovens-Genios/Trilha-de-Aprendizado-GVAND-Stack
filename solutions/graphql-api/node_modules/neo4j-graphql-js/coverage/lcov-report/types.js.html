...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> types.js</h1>
        <div class='clearfix'>
...
<a name='L111'></a><a href='#L111'>111</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">3x</span>
...
&nbsp;
    return mapping[t] || <span class="branch-1 cbranch-no" title="branch not covered" >'String';</span>
  };
&nbsp;
...
&nbsp;
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (has(set, 'Integer') &amp;&amp; has(set, 'Float')) {
            return 'Float';
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          return '</span>String';
        }, null)
    ) + mandatoryModifier
  );
};
...
const label2GraphQLType = label =&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (_.isNil(label)) {
<span class="cstat-no" title="statement not covered" >    throw n</span>ew Error('Cannot convert nil label to GraphQL type');
  }
&nbsp;
